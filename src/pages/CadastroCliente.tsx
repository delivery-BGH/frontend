  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} >
      ...
      <div >
        ...
        <Input className="bg-background" type="number" maxLength={11} {...register('cpf')} />
        {errors.cpf && <span>{errors.cpf.message}</span>}
      </div>

      <div >
        <label htmlFor="celular">Celular</label>
        <Input className="bg-background" type="number"{...register('celular')} />
      ...
      <div>
        ...
        <Input className="bg-background" type="number"{...register('numero')} />
