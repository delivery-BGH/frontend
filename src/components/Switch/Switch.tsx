...
import { Switch as SwitchHeadlessUi, type SwitchProps as HeadlessSwitchProps } from '@headlessui/react'
...
const Switch = ({ defaultEnable: enabledByDefault, disabled, onChange, ...rest }: SwitchProps) => {
